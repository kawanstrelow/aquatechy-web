  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_today:
          'bg-slate-100 text-slate-900 aria-selected:bg-slate-900 aria-selected:text-slate-50 dark:bg-slate-800 dark:text-slate-50 dark:aria-selected:bg-slate-50 dark:aria-selected:text-slate-900',
        day_outside:
